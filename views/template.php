...
<head>
    ...
    ?>
    <!-- CSS only -->
    <link rel="stylesheet" href="<?php echo $url ?>views/css/styles.css?v=3.6">
    <!-- Bootstrap CSS -->
...
<body style="background: #f9f9f9;">
	...
	if (isset($_GET['ruta'])) {
        ...
        }elseif($ruta == "aceptar-y-enviar-encuesta" && isset($rutas[1])){
            include "overall/admin/aceptarYEnviarEncuesta.php";
...
<script src="<?php echo $url ?>views/js/encuestas.js?v=3.7"></script>
